        ...
        <tbody>
          ...
          foreach ($c_t_t_t_penjualan_rincian as $key => $value) {
            ...
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<td>" . number_format($value->DISKON_P_1, 2, '.', ',') . "</td>";
              echo "<td>" . number_format($value->DISKON_P_2, 2, '.', ',') . "</td>";
              echo "<td>" . number_format($value->DISKON_HARGA, 2, '.', ',') . "</td>";
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<td><s>" . number_format($value->DISKON_P_1, 2, '.', ',') . "</s></td>";
              echo "<td><s>" . number_format($value->DISKON_P_2, 2, '.', ',') . "</s></td>";
              echo "<td><s>" . number_format($value->DISKON_HARGA, 2, '.', ',') . "</s></td>";

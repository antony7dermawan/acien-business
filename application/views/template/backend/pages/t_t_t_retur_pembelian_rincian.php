<div class="card">
  <div class="card-header">
      ...
      foreach ($c_t_t_t_retur_pembelian_by_id as $key => $value) {
        $inv = $value->INV;
      }
  ...
  <div class="card-block">
    ...
    <a href="<?= base_url("c_t_t_t_retur_pembelian"); ?>" class="btn waves-effect waves-light btn-inverse"><i class="icofont icofont-double-left"></i>Back</a>
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_t_t_retur_pembelian_rincian as $key => $value) {
            ...
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<td>";
                ...
                echo "<a href='".site_url('c_t_t_t_retur_pembelian_rincian/delete/'.$value->ID.'/'.$retur_pembelian_id)."' ";
...
<form action="<?php echo base_url('c_t_t_t_retur_pembelian_rincian/tambah/'.$retur_pembelian_id) ?>" method="post" id='add_data'>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_t_t_retur_pembelian_rincian/edit_action/'.$retur_pembelian_id) ?>" method="post" autocomplete="off" id='edit_data'>
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const read_data = <?= json_encode($c_t_t_t_retur_pembelian_rincian) ?>;

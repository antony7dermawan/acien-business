  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_p_t_angsuran as $key => $value) 
          {
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              */
              ...
              echo "<a href='".site_url('c_t_p_t_angsuran/delete/' . $value->ID)."' ";
              ?>
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<a href='".site_url('c_t_p_t_angsuran/undo_delete/' . $value->ID)."' ";
              ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_t_p_t_angsuran/tambah') ?>" method="post" id='add_data'>

<div class="card">
  <div class="card-header">
    <form action='<?php echo base_url("c_t_t_t_pembelian/date_pembelian"); ?>' class='no_voucer_area' method="post" id=''>
      <table>
        <tr>
          <th>
            Tanggal Transaksi:
          ...
          <th>
            <form action='/action_page.php'>
              <input type='date' class='form-control' name='date_pembelian' value='<?= $this->session->userdata('date_pembelian') ?>' onchange='this.form.submit();'>
          </th>
        </tr>
      </table>
...
<form action="<?php echo base_url('c_t_t_t_pembelian/tambah') ?>" method="post" id='add_data'>
...
<script>
  const read_data = <?= json_encode($c_t_t_t_pembelian) ?>;

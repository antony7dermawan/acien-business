<div class="card">
  <div class="card-header">
      ...
      foreach ($c_t_t_t_retur_pemakaian_by_id as $key => $value) {
        $inv = $value->INV;
  ...
  <div class="card-block">
    ...
    <a href="<?= base_url("c_t_t_t_retur_pemakaian"); ?>" class="btn waves-effect waves-light btn-inverse"><i class="icofont icofont-double-left"></i>Back</a>
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_t_t_retur_pemakaian_rincian as $key => $value) {
            ...
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<td>";
                ...
                echo "<a href='".site_url('c_t_t_t_retur_pemakaian_rincian/delete/'.$value->ID.'/'.$retur_pemakaian_id)."' ";
...
<form action="<?php echo base_url('c_t_t_t_retur_pemakaian_rincian/tambah/'.$retur_pemakaian_id) ?>" method="post" id='add_data'>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="form-group">
            ...
            <select name="pemakaian_rincian_id" class='barang_id' id='select-state' placeholder='Pick a state...'>
              <option value="0"></option>
              <?php
              foreach ($c_t_m_d_barang as $key => $value) 
              {
                echo "<option value='".$value->ID."'>".$value->KODE_BARANG."/".$value->BARANG."/".$value->MERK_BARANG."/".$value->PART_NUMBER." |limit=".$value->SISA_QTY." |Harga=".number_format($value->HARGA)."</option>";
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_t_t_retur_pemakaian_rincian/edit_action/'.$retur_pemakaian_id) ?>" method="post" autocomplete="off" id='edit_data'>
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const read_data = <?= json_encode($c_t_t_t_retur_pemakaian_rincian) ?>;

  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_p_t_pinjaman as $key => $value) 
          {
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<td> Rp" . number_format(intval($value->SISA_VALUE)) . "</td>";
              ...
              */
              ...
              echo "<a href='".site_url('c_t_p_t_pinjaman/delete/' . $value->ID)."' ";
              ?>
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<td><s> Rp" . number_format(intval($value->SISA_VALUE)) . "<s></td>";

              echo "<td>";
               
              

              echo "<a href='".site_url('c_t_p_t_pinjaman/undo_delete/' . $value->ID)."' ";
              ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_t_p_t_pinjaman/tambah') ?>" method="post" id='add_data'>

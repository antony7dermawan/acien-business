<div class="card">
  ...
  <div class="card-block">
    ...
    <form action='<?php echo base_url("c_t_t_payroll/change_date"); ?>' class='' method="post" id=''>
    <label>Pilih Kategori:</label>

    <select name="month_value" class='' onchange='this.form.submit();' id='select-state' placeholder='Pick a state...'>
      <?php
        for($i=0;$i<$live_month;$i++)
        {
          $option_month[$i] = $month[$i];
          $option_month_value[$i] = $month_value[$i];

          if($this->session->userdata('choosed_month')==$option_month_value[$i])
          {
            echo "<option value='".$option_month_value[$i]."' selected>".$option_month_value[$i].'.'.$option_month[$i]."</option>";
          }
          else
          {
            echo "<option value='".$option_month_value[$i]."'>".$option_month_value[$i].'.'.$option_month[$i]."</option>";
          }
        }
      ?>
    </select>

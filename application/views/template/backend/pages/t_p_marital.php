        ...
        <tbody>
          ...
          foreach ($c_t_p_marital as $key => $value) 
          {
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<a href='".site_url('c_t_p_marital/delete/' . $value->ID)."' ";
              ?>
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<td><s>".$value->MARITAL."</s></td>";
            
              echo "<td>";
               
              

              echo "<a href='".site_url('c_t_p_marital/undo_delete/' . $value->ID)."' ";
              ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_t_p_marital/tambah') ?>" method="post">
        ...
        <div class="modal-body">
          <div class="">
            ...
            <div class="form-group">
              <label>Marital</label>
              <input type='text' class='form-control' placeholder='Input Text' name='marital'>
            </div>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_p_marital/edit_action') ?>" method="post">
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const users = <?= json_encode($c_t_p_marital) ?>;
  console.log(users);

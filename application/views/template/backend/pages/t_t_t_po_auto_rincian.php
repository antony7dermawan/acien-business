<div class="card">
  ...
  <div class="card-block">
    ...
    <a href="<?= base_url("c_t_t_t_po_auto"); ?>" class="btn waves-effect waves-light btn-inverse"><i class="icofont icofont-double-left"></i>Back</a>
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_t_t_po_auto_rincian as $key => $value) {
            ...
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<td>" . number_format(floatval(intval($value->SISA_QTY, 2, '.', ',') . "</td>";
              ...
              if (intval($value->QTY) == intval($value->SISA_QTY))
              {
                ...
                echo "<a href='".site_url('c_t_t_t_po_auto_rincian/delete/'.$value->ID.'/'.$pembelian_id)."' ";
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<td><s>" . number_format(floatval(intval($value->SISA_QTY, 2, '.', ',') . "</s></td>";
...
<form action="<?php echo base_url('c_t_t_t_po_auto_rincian/tambah/'.$pembelian_id) ?>" method="post" id='add_data'>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_t_t_po_auto_rincian/edit_action/'.$pembelian_id) ?>" method="post" autocomplete="off" id='edit_data'>
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const read_data = <?= json_encode($c_t_t_t_po_auto_rincian) ?>;

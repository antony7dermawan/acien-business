  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_t_t_pemakaian_rincian as $key => $value) {
            ...
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              {
                echo "<a href='".site_url('c_t_t_t_pemakaian_rincian/delete/'.$value->ID.'/'.$pemakaian_id)."' ";
...
<form action="<?php echo base_url('c_t_t_t_pemakaian_rincian/tambah/'.$pemakaian_id) ?>" method="post" id='add_data'>

...
class C_t_p_t_potongan_lain extends MY_Controller
{
  ...
  {
    $this->session->set_userdata('t_p_t_potongan_lain_delete_logic', '1');
    ...
    $data = [
      "c_t_p_t_potongan_lain" => $this->m_t_p_t_potongan_lain->select(),

      "c_t_p_personal" => $this->m_t_p_personal->select(),

     

      "title" => "Transaksi Potongan Lain",
      "description" => "Input semua potongan disini"
    ];
    $this->render_backend('template/backend/pages/t_p_t_potongan_lain', $data);
  }
  ...
  public function delete($id)
  {
    ...
    $this->m_t_p_t_potongan_lain->update($data, $id);
    $this->session->set_flashdata('notif', '<div class="alert alert-danger icons-alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="icofont icofont-close-line-circled"></i></button><p><strong>Success!</strong> Data Berhasil DIhapus!</p></div>');
    redirect('/c_t_p_t_potongan_lain');
  }
  ...
  function tambah()
  {
    ...
    $this->m_t_p_t_potongan_lain->tambah($data);

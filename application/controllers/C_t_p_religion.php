...
class C_t_p_religion extends MY_Controller
{
  ...
  {
    $this->session->set_userdata('t_p_religion_delete_logic', '1');
    $data = [
      "c_t_p_religion" => $this->m_t_p_religion->select(),
      "title" => "Master Religion",
      "description" => "Religion untuk Payroll"
    ];
    $this->render_backend('template/backend/pages/t_p_religion', $data);
  }
  ...
  public function delete($id)
  {
    ...
    $this->m_t_p_religion->update($data, $id);
    $this->session->set_flashdata('notif', '<div class="alert alert-danger icons-alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="icofont icofont-close-line-circled"></i></button><p><strong>Success!</strong> Data Berhasil DIhapus!</p></div>');
    redirect('/c_t_p_religion');
  }
  ...
  function tambah()
  {
    ...
    $religion = substr($this->input->post("religion"), 0, 50);
    ...
    $this->m_t_p_religion->tambah($data);
